...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        ItemPool mDefaultItemPool;
        [Title("Origin","Default")]
        [SerializeField , LabelText("生成物件設定 (Item Prefab)")]
        List<ItemPrefabConfData> mItemPrefabDataList = new List<ItemPrefabConfData>();

        [SerializeField, LabelText("對齊方向 (Arrange Type)")]
        ...
        //[SerializeField, LabelText("支援側邊滾動條 (Scroll Bar)")]
        ...
        float mSnapFinishThreshold = 50f;
        float mSnapVecThreshold = 145;
        float mSnapMoveDefaultMaxAbsVec = 3400f;
        [Title("Origin", "Snap")]
        [SerializeField, LabelText("啟用滑動對齊"),DetailedInfoBox("滑動對齊相關的注意事項", "1.對應事件mOnSnapItemFinished / mOnSnapNearestChanged")]
        bool mItemSnapEnable = true;
        ...
        [SerializeField, LabelText("滑動中心點(ViewPort)"),EnableIf("mItemSnapEnable")]
        protected Vector2 mViewPortSnapPivot = Vector2.zero;
        [SerializeField, LabelText("滑動中心點(Item)"), EnableIf("mItemSnapEnable")]
        protected Vector2 mItemSnapPivot = Vector2.zero;
        ...
        {
            return GetDefaultItemPrefabConfData()?.mItemPrefab;
        }
        public ItemPrefabConfData GetDefaultItemPrefabConfData() 
        {
            if (mItemPrefabDataList == null || mItemPrefabDataList.Count == 0)
                return null;

            return mItemPrefabDataList[0];
        }
        ...
        */
            ...
            LoopListViewInitParam initParam = null)
        {
            ...
            //預設值，但太小了，動態往上調
            if (mSnapFinishThreshold == 0.01f)
            {
                mSnapFinishThreshold = 50f;
            }
            ...
            mSupportScrollBar = mItemTotalCount > 0;
        ...
        public void UpdateInitParam(LoopListViewInitParam initParam)
        {
            if (initParam == null)
                return;
        ...
        */
        public void SetListItemCount(int itemCount, bool resetPos = true)
        {
            ...
            if (mItemTotalCount == 0)
            {
                ...
                ClearAllTmpRecycledItem();
                UpdateContentSize();
                mDefaultItemPool?.DestroyAllItem();
                return;
            }
        ...
        */
        ...
        public LoopListViewItem2 NewListViewItemByDefault() 
        {
            return NewListViewItem(mDefaultItemPool);
        }
        public LoopListViewItem2 NewListViewItem(string itemPrefabName)
        {
            ...
            return NewListViewItem(pool);
        }
        private LoopListViewItem2 NewListViewItem(ItemPool pool)
        {
            if(pool == null)
            {
                return null;
        ...
        */
        ...
        void InitItemPool()
        {
            ...
            mDefaultItemPool = mItemPoolList.Count > 0 ? mItemPoolList[0] : null;
        }
